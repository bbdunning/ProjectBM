...
function(_findAssimp_vsbinary target)
    ...
    if(NOT EXISTS "${ASSIMP_DIR}/lib/assimp-vc140-mtd.lib")
#        message(FATAL_ERROR "Missing required visual studio pre-compiled library!")
    endif()
    set(ASSIMP_LIBRARIES "${ASSIMP_DIR}/lib/assimp-vc140-mtd.lib" PARENT_SCOPE)
...
#             target_link_libraries(${target} "C:/Users/Alex Hua/vcpkg/packages/assimp_x86-windows/debug/bin/assimp-vc140-mtd.dll")
